            ...
            @csrf
              <div class="card mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2"></div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-2">
                          @if($data->basic_logo!='')
                            <img height="40px" src="{{asset('uploads/basic/'.$data->basic_logo)}}" alt="logo ">
                          @else
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-2">
                          @if($data->basic_favicon!='')
                            <img height="40px" src="{{asset('uploads/basic/'.$data->basic_favicon)}}" alt="favicon ">
                          @else
                            <img height="40px" src="{{asset('contents')}}/images/avatar.png">
                          @endif
                      </div>
                ...
                <div class="row mb-3">
                      ...
                      <div class="col-md-2">
                          @if($data->basic_flogo!='')
                            <img height="40px" src="{{asset('uploads/basic/'.$data->basic_flogo)}}" alt="flogo"/>
                          @else
                            <img height="40px" src="{{asset('contents')}}/images/avatar.png"/>
                          @endif
                      </div>
