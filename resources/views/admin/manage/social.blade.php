            ...
            @csrf
              <div class="card mb-3">
                <div class="card-header">
                  <div class="row">
                      ...
                      <div class="col-md-4 card_button_part">
                          <a href="{{url('dashboard/manage/social ')}}" class="btn btn-sm btn-dark"><i class="fas fa-th"></i>Social Media Information</a>
                      </div>  
                  </div>
                </div>
                <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="input-group mb-3">
                      <span class="input-group-text"><i class="fab fa-linkedin ln"></i></span>
