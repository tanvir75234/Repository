                ...
                <div class="card-header">
                  <div class="row">
                      <div class="col-md-8 card_title_part">
                          <i class="fab fa-gg-circle"></i>Social Information
                      </div>  
                      <div class="col-md-4 card_button_part">
                          <a href="{{url('dashboard/manage/contact ')}}" class="btn btn-sm btn-dark"><i class="fas fa-th"></i>Social Media Information</a>
                      </div>  
                  </div>
                </div>
                <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" name="address1" value="{{$data->ci_address1}}">
                    </div>     
                  </div>
                  <div class="col-md-6">
                    <div class="input-group mb-3">
                      <span class="input-group-text"><i class="fas fa-home"></i></span>
                      <input type="text" class="form-control" name="address2" value="{{$data->ci_address2}}">
                    </div>     
                  </div>
                  <div class="col-md-6">
                    <div class="input-group mb-3">
                      <span class="input-group-text"><i class="fas fa-home"></i></span>
                      <input type="text" class="form-control" name="address3" value="{{$data->ci_address3}}">
                    </div>     
                  </div>
                  <div class="col-md-6">
                    <div class="input-group mb-3">
                      <span class="input-group-text"><i class="fas fa-home"></i></span>
                      <input type="text" class="form-control" name="address4" value="{{$data->ci_address4}}">
                    </div>     
                  </div>
                </div>
