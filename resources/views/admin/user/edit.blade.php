                ...
                <div class="row">
                  ...
                  <div class="col-md-2"></div>
                    ...
                    <div class="row mb-3 {{ $errors->has('username')?'has-error':'' }}">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control form_control" id="" name="username" value="{{$data->username}}" redonly >
                    ...
                    <div class="row mb-3">
                      ...
                      <td>
                          @if($data->photo!='')
                            <img height="100px" src="{{asset('uploads/user/'.$data->photo)}}" alt="User Photo">
                          @else
                            <img height="100px" src="{{asset('contents')}}/images/avatar.png">
                          @endif
                      </td>
                      </div>
                    </div>
