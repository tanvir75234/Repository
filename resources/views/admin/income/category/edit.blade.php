                ...
                <div class="card-header">
                  <div class="row">
                      ...
                      <div class="col-md-4 card_button_part">
                          <a href="{{url('dashboard/income/category')}}" class="btn btn-sm btn-dark"><i class="fas fa-th"></i>All Income Category Information</a>
                      </div>  
                  </div>
                </div>
                <div class="card-body">
                  ...
                  @endif
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-7">
                        <textarea type="text" class="form-control form_control" id="" name="remarks">{{$data->incate_remarks}}</textarea>
                      </div>
                    </div>                  
                </div>
