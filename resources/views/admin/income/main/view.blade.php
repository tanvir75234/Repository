            ...
            <div class="card-header">
              <div class="row">
                  ...
                  <div class="col-md-4 card_button_part">
                      <a href="{{url('dashboard/income ')}}" class="btn btn-sm btn-dark"><i class="fas fa-th"></i>All User</a>
                  </div>  
              </div>
            </div>
            <div class="card-body">
                  ...
                  <div class="col-md-8">
                      <table class="table table-bordered table-striped table-hover custom_view_table">
                        ...
                        <tr>
                          <td>Created Time</td>  
                          <td>:</td>  
                          <td>{{$data->created_at->format('d-M-Y | h:m:s A')}}</td>  
                        </tr>
                        ...
                        <tr>
                          <td>Updated Time</td>  
                          <td>:</td>  
                          <td>{{$data->updated_at->format('d-M-Y | h:m:s A')}}</td>  
                        </tr>
                        @endif
                      </table>
                  </div>
