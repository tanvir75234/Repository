...
@section('content')
@php
  $all=App\Models\Expense::where('expense_status',0)->orderBy('expense_id','DESC')->get();
@endphp
  <div class="row">
      <div class="col-md-12">
          <div class="card mb-3">
            <div class="card-header">
              <div class="row">
                  <div class="col-md-8 card_title_part">
                      <i class="fab fa-gg-circle"></i> Recycle Expene Information
                  </div>  
              ...
              <table class="table table-bordered table-striped table-hover custom_table">
                ...
                <tbody>
                  ...
                  <td>{{date('d-M-Y',strtotime($data->expense_date))}}</td>
                    ...
                    <td>
                      <a href="#" id="restore" data-bs-toggle="modal" data-bs-target="#restoreModal" data-id="{{$data->expense_id}}"><i class="fas fa-recycle text-success fs-5 mx-2"></i></a>
                      <a href="#" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="{{$data->expense_id}}"><i class="fas fa-trash text-danger fs-5"></i></a>
                    </td>
                  </tr>
                  @endforeach()
                </tbody>
